...
/* anti-tampering: stops any attempts to utilize the `LD_PRELOAD` envvar */
...
/* anti-tampering: check if other executable code is mmapped by reading memory mappings for unwanted code */
